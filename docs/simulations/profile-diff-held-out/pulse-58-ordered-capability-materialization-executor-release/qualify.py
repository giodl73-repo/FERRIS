#!/usr/bin/env python3
"""Run Pulse 58's sealed fake-only qualification cycles."""
...
WORK_ROOT = REPO_ROOT / "target" / "pulse-58-qualification-runtime"
...
from sealed_dependencies import canonical_bytes, load_exact_p57_stack, sha256_bytes  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if WORK_ROOT.exists():
            cleanup_synthetic_runtime_root(WORK_ROOT)
    payload = {
        "schema": "ferris.pulse-58-ordered-capability-materialization-executor-qualification/v1",
        "outcome": "pass",
        "cycles_required": 20,
    ...
    if args.write_receipt:
        ...
        envelope = {"payload": payload, "payload_sha256": digest, "receipt_id": digest, "schema": "ferris.pulse-58-ordered-capability-materialization-executor-qualification-envelope/v1"}
