#!/usr/bin/env python3
"""Generate Pulse 73's complete-tree manifest and release seal."""
...
SCHEMA_PATH = (
    "schemas/"
    "ferris.pulse-73-ordered-capability-materialization-executor-stage-identity-successor.v1.schema.json"
)
...
def public_files() -> list[Path]:
    ...
    if residue:
        raise RuntimeError(
            "P73 release tree contains Python cache residue: "
...
def main() -> None:
    ...
    manifest = {
        ...
        "schema": "ferris.pulse-73-ordered-capability-materialization-executor-stage-identity-successor-manifest/v1",
        "scope": (
            "Ordered capability/materialization successor preserving exact Pulse 70/P58 "
            "behavior while loading only a local sibling sealed binder and explicitly "
            "binding exact Pulse 72 for capability execution."
        ),
    ...
    payload = {
        "schema": "ferris.pulse-73-ordered-capability-materialization-executor-stage-identity-successor-seal-payload/v1",
        "manifest": {
        ...
        "scope": {
            ...
            "exact_p72_capability_binding": True,
    ...
    write(
        ROOT / "release-seal.json",
        {
            ...
            "seal_id": identity,
            "schema": "ferris.pulse-73-ordered-capability-materialization-executor-stage-identity-successor-seal/v1",
        },
    )
