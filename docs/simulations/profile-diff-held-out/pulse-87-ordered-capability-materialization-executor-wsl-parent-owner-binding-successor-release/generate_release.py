#!/usr/bin/env python3
"""Generate Pulse 87's complete-tree manifest and release seal."""
...
SCHEMA_PATH = (
    "schemas/"
    "ferris.pulse-87-ordered-capability-materialization-executor-wsl-parent-owner-binding-successor.v1.schema.json"
)
...
def public_files() -> list[Path]:
    ...
    if residue:
        raise RuntimeError(
            "P87 release tree contains Python cache residue: "
...
def main() -> None:
    ...
    manifest = {
        ...
        "schema": "ferris.pulse-87-ordered-capability-materialization-executor-wsl-parent-owner-binding-successor-manifest/v1",
        "scope": (
            ...
            "every local and transitive exact Pulse 39/P41/P52/P35/P86 load with the "
            "final Pulse 74/P59 kernel-lock discipline, fully verifying the exact "
            "Pulse 35 release tree without alternate source digests, and explicitly "
            "binding exact Pulse 86 for capability execution."
        ),
    ...
    payload = {
        "schema": "ferris.pulse-87-ordered-capability-materialization-executor-wsl-parent-owner-binding-successor-seal-payload/v1",
        "manifest": {
        ...
        "scope": {
            ...
            "exact_p35_complete_release_tree_binding": True,
            "exact_p35_p39_p41_p52_ordering": True,
            "exact_p86_capability_binding": True,
    ...
    write(
        ROOT / "release-seal.json",
        {
            ...
            "seal_id": identity,
            "schema": "ferris.pulse-87-ordered-capability-materialization-executor-wsl-parent-owner-binding-successor-seal/v1",
        },
    )
