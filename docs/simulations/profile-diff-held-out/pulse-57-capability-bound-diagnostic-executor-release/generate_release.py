#!/usr/bin/env python3
"""Generate Pulse 57's complete-tree manifest and seal."""
...
def main() -> None:
    ...
    manifest = {
        ...
        "schema": "ferris.pulse-57-capability-bound-diagnostic-executor-manifest/v1",
        "scope": "Capability-bound Pulse 56 custody successor preserving exact Pulse 51 semantics; fake-only qualification and no diagnostic authority.",
    ...
    payload = {
        ...
        "schema": "ferris.pulse-57-capability-bound-diagnostic-executor-seal-payload/v1",
        "scope": {
            "diagnostic_authority": False,
            "ferris_executed_in_qualification": False,
            "p44_p45_execution": False,
            "pulse_56_capability_build_custody": True,
        },
    }
    ...
    write(
        ROOT / "release-seal.json",
        {
            ...
            "seal_id": identity,
            "schema": "ferris.pulse-57-capability-bound-diagnostic-executor-seal/v1",
        },
    )
