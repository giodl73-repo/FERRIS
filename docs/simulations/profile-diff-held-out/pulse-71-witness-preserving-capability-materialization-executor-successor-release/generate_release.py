#!/usr/bin/env python3
"""Generate Pulse 71's complete-tree manifest and release seal."""
...
RELEASE_ROOT = (
    ...
    "pulse-71-witness-preserving-capability-materialization-executor-successor-release"
)
SCHEMA_PATH = (
    "schemas/"
    "ferris.pulse-71-witness-preserving-capability-materialization-executor-successor.v1.schema.json"
)
...
def public_files() -> list[Path]:
    ...
    if residue:
        raise RuntimeError(
            "P71 release tree contains Python cache residue: "
...
def main() -> None:
    ...
    manifest = {
        ...
        "schema": (
            ...
            "executor-public-manifest/v1"
        ),
        "scope": (
            "Witness-preserving terminal infrastructure only: exact Pulse 70 "
            "delegation, exact Pulse 51/Pulse 47 one-use terminalization after "
            "private cleanup, path-free transfer descriptors, and no diagnostic "
            "authority or real execution."
        ),
    ...
    payload = {
        ...
        "qualification_receipt": {
            ...
            "published_failure_witnesses": receipt["payload"][
                "published_failure_witnesses"
            ],
        ...
        "limits": {
            ...
            "publication_not_attempted_before_p70_completion": True,
