#!/usr/bin/env python3
"""Generate Pulse 82's complete-tree manifest and release seal."""
...
RELEASE_ROOT = (
    ...
    "pulse-82-witness-preserving-capability-materialization-executor-pulse35-release-tree-successor-release"
)
SCHEMA_PATH = (
    "schemas/"
    "ferris.pulse-82-witness-preserving-capability-materialization-executor-pulse35-release-tree-successor.v1.schema.json"
)
...
def public_files() -> list[Path]:
    ...
    if residue:
        raise RuntimeError(
            "P82 release tree contains Python cache residue: "
...
def main() -> None:
    ...
    manifest = {
        ...
        "schema": (
            ...
            "executor-pulse35-release-tree-successor-public-manifest/v1"
        ),
        "scope": (
            ...
            "delegating exact ordered execution to Pulse 81, including its exact "
            "Pulse 35 release-tree binding and Pulse 78 capability chain."
        ),
    ...
    payload = {
        "schema": (
            "ferris.pulse-82-witness-preserving-capability-materialization-"
            "executor-pulse35-release-tree-successor-seal-payload/v1"
        ),
        "manifest": {
        ...
        "scope": {
            ...
            "exact_p81_execution": True,
            "exact_p81_p35_release_tree_chain": True,
        ...
        "limits": {
            ...
            "publication_not_attempted_before_p81_completion": True,
    ...
    write(
        ROOT / "release-seal.json",
        {
            ...
            "schema": (
                "ferris.pulse-82-witness-preserving-capability-materialization-"
                "executor-pulse35-release-tree-successor-seal/v1"
            ),
            "seal_id": identity,
        },
    )
