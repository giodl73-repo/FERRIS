...
callback, environment mapping, or arbitrary control. It does not call a Pulse 69
top-level executor, P44/P45, P47, or P43 publication route.

The callable first byte-binds complete P35, P39, P41, P52, and Pulse 69 sealed
release trees and APIs. Pulse 69 itself binds exact Pulse 57/P51/P56 from held
source bytes while owning native staged-bundle cleanup.
...
Pulse 70 delegates Pulse 69's exact P57-compatible normalization, semantic
projection, worker, capability-close, and first-stop semantics while retaining
lexical no-follow identity itself. Directory identities use `lstat`,
available `O_DIRECTORY|O_NOFOLLOW` descriptor checks, file IDs, and repeated
prelaunch rechecks without resolving a link; Pulse 69 module globals remain
unmodified.
...
terminal path Pulse 70 closes both live capabilities/worker, removes the seed,
