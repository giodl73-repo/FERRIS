#!/usr/bin/env python3
"""Generate Pulse 70's complete-tree manifest and release seal."""
...
def public_files() -> list[Path]:
    ...
    if residue:
        raise RuntimeError(
            "P70 release tree contains Python cache residue: "
...
def main() -> None:
    ...
    manifest = {
        ...
        "schema": "ferris.pulse-70-ordered-capability-materialization-executor-successor-manifest/v1",
        "scope": "Ordered capability/materialization successor binding Pulse 69's cleanup-owning exact P57-compatible stack; fake-only qualification and no diagnostic authority or publication.",
    ...
    payload = {
        ...
        "schema": "ferris.pulse-70-ordered-capability-materialization-executor-successor-seal-payload/v1",
        "scope": {
    ...
    write(ROOT / "release-seal.json", {"payload": payload, "payload_sha256": identity, "seal_id": identity, "schema": "ferris.pulse-70-ordered-capability-materialization-executor-successor-seal/v1"})
