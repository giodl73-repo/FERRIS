...
- [`ferris.pulse-35-corpus-materializer.v1.schema.json`](ferris.pulse-35-corpus-materializer.v1.schema.json)
  ...
  `false`, `false`, and `0`. The current Git-clean schema is LF. Pulse 35's
  sealed external schema binding remains its historical CRLF identity;
  validators reconstruct that identity without treating CRLF as the current
  repository artifact.
...
42. Typed contract objects reject unknown members; the profile-evidence schema
intentionally permits recursive section objects only while constraining every
member name and recursive value.
...
- [`ferris.process-exit-diagnostic-pulse-68-authority.v1.schema.json`](ferris.process-exit-diagnostic-pulse-68-authority.v1.schema.json)
  remains the recursively closed Draft 2020-12 schema for the historical Pulse
  68 authority declaration. That declaration still binds exact cutoff
  ...
  Pulse 68 under `P68-P57-STAGED-BUNDLE-CLEANUP` because exact Pulse 57 stages
  a `.p57-*` bundle under caller-native `ubuntu_runtime_parent` and
  `_NativeWslSession.close()` never removes `staged.root` or verifies absence,
  so exact Pulse 58/Pulse 59 overclaimed cleanup over the final callable stack.
  The historical schema is not amended by that withdrawal: it remains the
...
- [`ferris.process-exit-diagnostic-pulse-65-authority.v1.schema.json`](ferris.process-exit-diagnostic-pulse-65-authority.v1.schema.json)
  remains the recursively closed Draft 2020-12 schema for the historical Pulse
  65 authority declaration. That declaration binds exact cutoff
  `e3b0b62f6dd62b5071886d32a9eedca85c76b4ae`, which contains the Pulse 64
  withdrawal and predates the authority, exact final Pulse 59, and the exact
  P27/P31/P35/P37/P39/P41/P43/P47/P51/P52/P56/P57/P58/P59 public releases and
  callables. Independent prelaunch review later withdrew Pulse 65 under
  `P65-P57-WSL-TWO-SPAWN-CONTRACT` because the sealed declaration still fixed
  one WSL spawn where exact Pulse 57 source uses distinct `subprocess.run`
