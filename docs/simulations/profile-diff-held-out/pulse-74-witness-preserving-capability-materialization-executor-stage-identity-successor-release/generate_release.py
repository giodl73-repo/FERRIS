#!/usr/bin/env python3
"""Generate Pulse 74's complete-tree manifest and release seal."""
...
RELEASE_ROOT = (
    ...
    "pulse-74-witness-preserving-capability-materialization-executor-stage-identity-successor-release"
)
SCHEMA_PATH = (
    "schemas/"
    "ferris.pulse-74-witness-preserving-capability-materialization-executor-stage-identity-successor.v1.schema.json"
)
...
def public_files() -> list[Path]:
    ...
    if residue:
        raise RuntimeError(
            "P74 release tree contains Python cache residue: "
...
def main() -> None:
    ...
    manifest = {
        ...
        "schema": (
            ...
            "executor-stage-identity-successor-public-manifest/v1"
        ),
        "scope": (
            ...
            "delegating exact ordered execution to Pulse 73 over Pulse 72."
        ),
    ...
    payload = {
        "schema": (
            "ferris.pulse-74-witness-preserving-capability-materialization-"
            "executor-stage-identity-successor-seal-payload/v1"
        ),
        "manifest": {
        ...
        "scope": {
            ...
            "exact_p73_execution": True,
            "exact_p72_stage_identity_chain": True,
        ...
        "limits": {
            ...
            "publication_not_attempted_before_p73_completion": True,
    ...
    write(
        ROOT / "release-seal.json",
        {
            ...
            "schema": (
                "ferris.pulse-74-witness-preserving-capability-materialization-"
                "executor-stage-identity-successor-seal/v1"
            ),
            "seal_id": identity,
        },
    )
