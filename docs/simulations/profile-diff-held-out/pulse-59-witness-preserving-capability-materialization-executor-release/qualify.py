...
CONTROL_METHODS = {
    ...
    "local-binder-shares-singleton-and-lock": "test_two_executor_instances_share_singleton_local_binder_and_lock",
    "local-binder-rejects-foreign-private-key": "test_local_sealed_binder_rejects_foreign_private_key_preseed",
    "local-binder-cleans-stale-private-key-on-exception": "test_local_sealed_binder_exception_cleanup_removes_stale_private_key",
