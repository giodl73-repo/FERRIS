#!/usr/bin/env python3
"""Generate Pulse 59's complete-tree manifest and release seal."""
...
SCHEMA_PATH = (
    "schemas/"
    "ferris.pulse-59-witness-preserving-capability-materialization-executor.v1.schema.json"
)
...
def public_files() -> list[Path]:
    ...
    if residue:
        raise RuntimeError(
            "P59 release tree contains Python cache residue: "
...
def main() -> None:
    ...
    manifest = {
        ...
        "scope": (
            "Witness-preserving terminal infrastructure only: exact Pulse 58 "
    ...
    payload = {
        ...
        "limits": {
            ...
            "publication_not_attempted_before_p58_completion": True,
