#!/usr/bin/env python3
"""Generate Pulse 88's complete-tree manifest and release seal."""
...
RELEASE_ROOT = (
    ...
    "pulse-88-witness-preserving-capability-materialization-executor-wsl-parent-owner-binding-successor-release"
)
SCHEMA_PATH = (
    "schemas/"
    "ferris.pulse-88-witness-preserving-capability-materialization-executor-wsl-parent-owner-binding-successor.v1.schema.json"
)
...
def public_files() -> list[Path]:
    ...
    if residue:
        raise RuntimeError(
            "P88 release tree contains Python cache residue: "
...
def main() -> None:
    ...
    manifest = {
        ...
        "schema": (
            ...
            "executor-wsl-parent-owner-binding-successor-public-manifest/v1"
        ),
        "scope": (
            ...
            "delegating exact ordered execution to Pulse 87, including its exact "
            "Pulse 35 release-tree binding and Pulse 86 WSL parent-owner chain."
        ),
    ...
    payload = {
        "schema": (
            "ferris.pulse-88-witness-preserving-capability-materialization-"
            "executor-wsl-parent-owner-binding-successor-seal-payload/v1"
        ),
        "manifest": {
        ...
        "scope": {
            ...
            "exact_p87_execution": True,
            "exact_p87_p35_release_tree_chain": True,
            "exact_p86_wsl_parent_owner_binding_chain": True,
            "ordered_failure_nonpublication": True,
        ...
        "limits": {
            ...
            "publication_not_attempted_before_p87_completion": True,
    ...
    write(
        ROOT / "release-seal.json",
        {
            ...
            "schema": (
                "ferris.pulse-88-witness-preserving-capability-materialization-"
                "executor-wsl-parent-owner-binding-successor-seal/v1"
            ),
            "seal_id": identity,
        },
    )
