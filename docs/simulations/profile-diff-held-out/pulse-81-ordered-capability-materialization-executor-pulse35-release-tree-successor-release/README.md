...
Pulse 81 preserves exact Pulse 70 / Pulse 58 ordered behavior while rebasing
the live capability edge onto Pulse 78 and hardening the complete sealed load
graph:
...
- the sealed binder verifies exact Pulse 39, Pulse 41, Pulse 52, Pulse 35, and
  Pulse 78 release trees on every call, and Pulse 35 now requires the pinned
...
- ordered execution still performs one exact Pulse 39 / Pulse 41 public custody
  ...
  verification, descriptor freezing, and one exact Pulse 78 capability
...
Qualification is fake-only. It records 28 deterministic control IDs, including
...
tamper, and extra-tree-file injection, then runs 20 harmless cycles for 2,760
