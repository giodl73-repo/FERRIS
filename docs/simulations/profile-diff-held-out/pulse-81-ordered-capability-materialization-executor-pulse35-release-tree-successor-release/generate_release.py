#!/usr/bin/env python3
"""Generate Pulse 81's complete-tree manifest and release seal."""
...
SCHEMA_PATH = (
    "schemas/"
    "ferris.pulse-81-ordered-capability-materialization-executor-pulse35-release-tree-successor.v1.schema.json"
)
...
def public_files() -> list[Path]:
    ...
    if residue:
        raise RuntimeError(
            "P81 release tree contains Python cache residue: "
...
def main() -> None:
    ...
    manifest = {
        ...
        "schema": "ferris.pulse-81-ordered-capability-materialization-executor-pulse35-release-tree-successor-manifest/v1",
        "scope": (
            ...
            "every local and transitive exact Pulse 39/P41/P52/P35/P78 load with the "
            ...
            "binding exact Pulse 78 for capability execution."
        ),
    ...
    payload = {
        "schema": "ferris.pulse-81-ordered-capability-materialization-executor-pulse35-release-tree-successor-seal-payload/v1",
        "manifest": {
        ...
        "scope": {
            ...
            "exact_p78_capability_binding": True,
    ...
    write(
        ROOT / "release-seal.json",
        {
            ...
            "seal_id": identity,
            "schema": "ferris.pulse-81-ordered-capability-materialization-executor-pulse35-release-tree-successor-seal/v1",
        },
    )
