#!/usr/bin/env python3
"""Generate Pulse 77's complete-tree manifest and release seal."""
...
RELEASE_ROOT = (
    ...
    "pulse-77-witness-preserving-capability-materialization-executor-stage-bootstrap-worker-identity-successor-release"
)
SCHEMA_PATH = (
    "schemas/"
    "ferris.pulse-77-witness-preserving-capability-materialization-executor-stage-bootstrap-worker-identity-successor.v1.schema.json"
)
...
def public_files() -> list[Path]:
    ...
    if residue:
        raise RuntimeError(
            "P77 release tree contains Python cache residue: "
...
def main() -> None:
    ...
    manifest = {
        ...
        "schema": (
            ...
            "executor-stage-bootstrap-worker-identity-successor-public-manifest/v1"
        ),
        "scope": (
            "Witness-preserving terminal infrastructure preserving exact Pulse 71/P59 "
            "semantics while loading only a hardened local sibling binder and "
            "delegating exact ordered execution to Pulse 76 over Pulse 75."
        ),
    ...
    payload = {
        "schema": (
            "ferris.pulse-77-witness-preserving-capability-materialization-"
            "executor-stage-bootstrap-worker-identity-successor-seal-payload/v1"
        ),
        "manifest": {
        ...
        "scope": {
            ...
            "exact_p76_execution": True,
            "exact_p75_stage_bootstrap_worker_identity_chain": True,
        ...
        "limits": {
            ...
            "publication_not_attempted_before_p76_completion": True,
    ...
    write(
        ROOT / "release-seal.json",
        {
            ...
            "schema": (
                "ferris.pulse-77-witness-preserving-capability-materialization-"
                "executor-stage-bootstrap-worker-identity-successor-seal/v1"
            ),
            "seal_id": identity,
        },
    )
