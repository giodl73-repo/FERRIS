#!/usr/bin/env python3
"""Run Pulse 79's sealed fake-only qualification cycles."""
...
WORK_ROOT = REPO_ROOT / "target" / "pulse-79-qualification-runtime"
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if WORK_ROOT.exists():
            cleanup_synthetic_runtime_root(WORK_ROOT)
    payload = {
        "schema": "ferris.pulse-79-ordered-capability-materialization-executor-stage-capture-bootstrap-argv-successor-qualification/v1",
        "outcome": "pass",
        "cycles_required": 20,
    ...
    if args.write_receipt:
        ...
        envelope = {
            ...
            "receipt_id": digest,
            "schema": "ferris.pulse-79-ordered-capability-materialization-executor-stage-capture-bootstrap-argv-successor-qualification-envelope/v1",
        }
