#!/usr/bin/env python3
"""Generate Pulse 79's complete-tree manifest and release seal."""
...
SCHEMA_PATH = (
    "schemas/"
    "ferris.pulse-79-ordered-capability-materialization-executor-stage-capture-bootstrap-argv-successor.v1.schema.json"
)
...
def public_files() -> list[Path]:
    ...
    if residue:
        raise RuntimeError(
            "P79 release tree contains Python cache residue: "
...
def main() -> None:
    ...
    manifest = {
        ...
        "schema": "ferris.pulse-79-ordered-capability-materialization-executor-stage-capture-bootstrap-argv-successor-manifest/v1",
        "scope": (
            ...
            "Pulse 78 for capability execution."
        ),
    ...
    payload = {
        "schema": "ferris.pulse-79-ordered-capability-materialization-executor-stage-capture-bootstrap-argv-successor-seal-payload/v1",
        "manifest": {
    ...
    write(
        ROOT / "release-seal.json",
        {
            ...
            "seal_id": identity,
            "schema": "ferris.pulse-79-ordered-capability-materialization-executor-stage-capture-bootstrap-argv-successor-seal/v1",
        },
    )
