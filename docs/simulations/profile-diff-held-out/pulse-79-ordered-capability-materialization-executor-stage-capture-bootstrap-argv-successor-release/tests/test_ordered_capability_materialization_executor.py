...
class OrderedCapabilityMaterializationExecutorTests(unittest.TestCase):
    def setUp(self) -> None:
        self.work = REPO_ROOT / "target" / f"pulse-79-test-{uuid.uuid4().hex}"
    ...
    def _run(
        ...
        *,
        ...
        p78, p51, p56_real = stack or sealed.load_exact_p78_stack(REPO_ROOT)
    ...
    def test_exact_p78_binding_and_local_loader(self) -> None:
        p78, p51, p56 = sealed.load_exact_p78_stack(REPO_ROOT)
    ...
    def test_p27_bounded_failure_is_terminal_and_cleaned(self) -> None:
        _p69, p51, _p56 = sealed.load_exact_p78_stack(REPO_ROOT)
