...
Disposition: Superseded by Pulse 12 universal non-success remediation
...
FHIF-025 subsequently identified one non-success path that bypassed the v2
machine envelope. Pulse 12 makes typed stderr command results universal for
all non-success invocations.
