use super::{
    ...
    LEGACY_EXECUTION_RECEIPT_SCHEMA, OWNER_ENTRYPOINT_INTENTS_SCHEMA, OWNER_ENTRYPOINTS_SCHEMA,
...
pub fn create_contract_catalog() -> CommandEnvelope<ContractCatalog> {
    let mut contracts = vec![
        ...
        support(OWNER_ENTRYPOINT_INTENTS_SCHEMA, true, false),
        support(OWNER_ENTRYPOINTS_SCHEMA, true, true),
