...
| 03 | Ferris application contracts | in progress | Integrate RUNE, Ferris, the internal Blueprint model, layered Rust/ABI/WIT/wire contracts, supported profiles, Query Forest architecture, and evidence packets. |
