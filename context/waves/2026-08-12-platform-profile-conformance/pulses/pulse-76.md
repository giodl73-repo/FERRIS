...
capability layer from ambient predecessor resolution to the explicit Pulse 75
stage-bootstrap-worker-identity successor.
...
Pulse 39, Pulse 41, Pulse 52, and Pulse 75 releases through a verified
sibling-path sealed loader rather than ambient `sealed_dependencies`
resolution.

Pulse 76 preserves exact Pulse 70 / Pulse 58 ordering: one exact Pulse 39
...
descriptor freezing, bounded process search, and one exact Pulse 75 capability
sequence. Every local and transitive exact Pulse 39 / Pulse 41 / Pulse 52 /
Pulse 35 / Pulse 75 sealed load is serialized with the final Pulse 74 / Pulse
...
- [Release](../../../../docs/simulations/profile-diff-held-out/pulse-76-ordered-capability-materialization-executor-stage-bootstrap-worker-identity-successor-release/README.md)
- [Qualification receipt](../../../../docs/simulations/profile-diff-held-out/pulse-76-ordered-capability-materialization-executor-stage-bootstrap-worker-identity-successor-release/qualification-receipt.json)
...
- [Rust validator](../../../../crates/ferris-cli/tests/pulse_76_ordered_capability_materialization_executor_stage_bootstrap_worker_identity_successor_release.rs)
