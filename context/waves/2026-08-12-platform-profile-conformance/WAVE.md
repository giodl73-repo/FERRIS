...
Status: Active; Pulses 01 through 04 complete
...
| 05 | CLI and configuration family | Authorized | Exact controlled `r1` and `r2` family evidence plus reusable test-only family support |
